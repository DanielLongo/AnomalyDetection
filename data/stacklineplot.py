...
def stackplot(marray, seconds=None, start_time=None, ylabels=None, yscale=1.0, color=None):
    """
    ...
    stackplot_t(tarray, seconds=seconds, start_time=start_time, ylabels=ylabels, yscale=yscale, color=color)



def stackplot_t(tarray, seconds=None, start_time=None, ylabels=None, yscale=1.0, color=None):
    """
    will plot a stack of traces one above the other assuming
    ...
    if color:
        lines = LineCollection(segs, offsets=offsets,
                           transOffset=None,
                            colors=[color for i in range(len(segs))]
                           )
    else:
        lines = LineCollection(segs, offsets=offsets,
                           transOffset=None,
